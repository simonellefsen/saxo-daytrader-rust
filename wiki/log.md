...
- Added `DIA:arcx` as the Dow Jones Industrial Average ETF proxy pending Saxo SIM validation. Euronext and LSE need separately named regional index trackers because they are exchange venues, not directly comparable index series.

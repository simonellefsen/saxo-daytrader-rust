...
The audit implemented for U2 reports this automatically. After the 2026-07-26 automation-switch, exclusion, tax-estimate, and risk-sizing remediations, the shipped configuration has **28 enforced, 30 advisory, 36 unused, 20 of them risk-surface**, 0 uncontracted, 8 contracted-but-absent.

The remaining 20 keys that read as active risk controls and are not:

...
The audit implemented for U2 reports this automatically. After the 2026-07-26 automation-switch, exclusion, and tax-estimate remediation, the shipped configuration has **27 enforced, 30 advisory, 37 unused, 21 of them risk-surface**, 0 uncontracted, 8 contracted-but-absent.

The remaining 21 keys that read as active risk controls and are not:

...
The audit implemented for U2 reports this automatically. After the 2026-07-26 automation-switch, exclusion, tax-estimate, risk-sizing, BUY-cost, candidate-ceiling, per-symbol exposure-cap, and maximum-holdings remediations, the shipped configuration has **33 enforced, 29 advisory, 32 unused, 15 of them risk-surface**, 0 uncontracted, 8 contracted-but-absent.

The remaining 15 keys that read as active risk controls and are not:

...
The audit implemented for U2 reports this automatically. After the 2026-07-26 automation-switch, exclusion, tax-estimate, risk-sizing, and BUY-cost remediations, the shipped configuration has **30 enforced, 30 advisory, 34 unused, 18 of them risk-surface**, 0 uncontracted, 8 contracted-but-absent.

The remaining 18 keys that read as active risk controls and are not:

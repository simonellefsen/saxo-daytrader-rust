...
**Known gap after 3a:** once a discretionary sell cancels a stop, nothing re-places one over whatever quantity remains. That is point 2 plus point 3, and until they land a partial exit leaves the residual position unprotected until the next operator batch.

...
The audit implemented for U2 reports this automatically. After the 2026-07-26 automation-switch, exclusion, tax-estimate, risk-sizing, BUY-cost, candidate-ceiling, and per-symbol exposure-cap remediations, the shipped configuration has **32 enforced, 30 advisory, 32 unused, 16 of them risk-surface**, 0 uncontracted, 8 contracted-but-absent.

The remaining 16 keys that read as active risk controls and are not:

...
| P1 | Testing | Continue expanding workflow tests. The decision-action guard landed 2026-07-10 and the scheduled-report freshness/pulse guard landed 2026-07-14; next slices are Hermes advice, Trading Manager queueing, and execution queue dry-run paths. | Protects the most critical cross-module workflows. |

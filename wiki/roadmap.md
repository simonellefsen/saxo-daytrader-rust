...
| P0 | UI performance | Continue splitting dashboard reads per tab. | First slice landed 2026-07-13: Decision Report list queries now exclude prompt/request/response/report JSON except for the active Decision Reports or AI Prompts detail. Remaining work: stop loading 5,000 history rows and unrelated tab datasets, then add server-side pagination/detail endpoints. |

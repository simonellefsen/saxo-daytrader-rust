...
| P1 | Accounting integrity | Expand the new overview `integrity` checks with broker exposure aggregate reconciliation. UI surfacing and Slack routing landed 2026-07-09; operator acknowledgments for current mismatches/warnings landed 2026-07-10. | The May position_lots corruption (3.2M DKK cost basis on 31 shares) sat unnoticed for a month; invariants with alerts catch the next one in hours. |

...
| P1 | Price monitor | Continue market-hours-aware polling: session-first checks, closed-exchange skips, and UI visibility for skipped/closed symbols landed 2026-07-09; remaining work is an explicit slow off-hours heartbeat interval. | Cuts ~two-thirds of infoprice calls, stops `updated_at` implying freshness for closed markets, and reduces log churn during reauth gaps. |

...
pub(crate) const CHALLENGE_SET_VERSION: &str = "challenge-v2-2026-09-22";
...
mod generation {
    ...
    pub(super) const CHALLENGE_SETS: &[(&str, i64)] = &[
        ("docs/jev-challenge-v1.json", 55),
        ("docs/jev-challenge-v2.json", 53),
    ];
    const CHALLENGE_PATH: &str = "docs/jev-challenge-v2.json";
    ...
    pub(super) fn load(path: &str) -> Vec<ChallengeCase> {
...
mod frozen {
    ...
    fn the_frozen_challenge_sets_have_no_missed_falsehoods() {
        for (path, abstentions_at_freeze) in super::generation::CHALLENGE_SETS {
            let cases = super::generation::load(path);

...
impl AppState {
    ...
    pub async fn generate_decision_report_fallback(&self) -> Result<JsonValue> {
        ...
        // deterministic fallback report with the same database shape that the
        // Python/Node UI consumed. That makes manual triggers auditable while the
        // full Rust strategy engine is still being ported.
        ...
        let report_json = json!({
            ...
            "reasoning_steps": [
                ...
                "The full xAI decision engine is still owned by the legacy Python runtime.",
        ...
        let sql = format!(
            ...
            sql_escape(
                "Generated by Rust fallback; full xAI decision report generation is not yet ported."
            ),
